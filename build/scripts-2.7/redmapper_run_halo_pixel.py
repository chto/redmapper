...
if __name__ == '__main__':
    ...
    runRedmapperhaloPixelTask = redmapper.pipeline.RunRedmapper_haloPixelTask(args.configfile, args.pixel, args.nside, path=args.path)
    runRedmapperhaloPixelTask.run()
